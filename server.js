...
// 🌐 Orijinal statik dosya sunumun (Klasör düzenin bozulmayacak)
...
// PDF işlemleri (Embedding) yerel Ollama'da kalmaya devam ediyor, masrafsız
...
    altin: "Canlı piyasalarda güncel anlık 1 gram altın fiyatı 3000 TL civarında işlem görmesidir."
};
...
            model: "llama-3.1-8b-instant", // Özetleme için çok daha hızlı model kullanıldı
            messages: [
                {
                    role: "system",
...
// 🚀 PUPPETEER OPTİMİZASYONU: Tarayıcıyı tek seferlik açıp sekme kapatarak kullanır
...
// --- 🔴 SES / AKIŞ ENDPOINT'İ (GROQ API İLE HIZLANDIRILDI) ---
...
                    
                    // Groq argümanları string olarak dönderir, objeye çeviriyoruz
...
        let fullAnswer = "";
        
        // ⚡ Orijinal akış (stream) mantığın Groq'un data yapısına uyarlandı
...
app.listen(3000, () => console.log('🚀 Cedric-Chen GÜNCELLENDİ: Orijinal Yapı Korunarak Groq API Hızı Eklendi!')); hata varmı